...
class car:
    ...
    def choose_action(self, position, velocity, R, learn = True, print_results = False):
        ...
        print 'Vel Act:', self.velAct
        print 'Pos Act:', self.posAct
        print 'vel Weights', self.weights[self.previous_action,:self.n_states_vel]
        print 'pos weights', self.weights[self.previous_action,self.n_states_vel:]
